...
public class SimilarAdapter extends RecyclerView.Adapter<SimilarAdapter.ItemViewHolder> {
    ...
    @NonNull
    @Override
    public SimilarAdapter.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SimilarAdapter.ItemViewHolder itemViewHolder, int i) {
